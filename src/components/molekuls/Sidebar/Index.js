...
const sidebarTheme = {
  root: {
    ...
    inner:
      "h-full overflow-y-auto overflow-x-hidden rounded bg-gray-50 px-3 py-4 bg-white dark:bg-gray-800",
  },
  item: {
    ...
    <>
      <Navbar fluid rounded className="fixed w-full top-0 z-50 bg-white">
        ...
        <div className="flex md:order-2">
          <Dropdown arrowIcon={false} inline label={<p>{user.role_name}</p>}>
            <Dropdown.Header>
          ...
          <Sidebar.ItemGroup>
            ...
            <Sidebar.Collapse
              ...
              renderChevronIcon={(theme, open) => {
                const IconComponent = open ? IconChevronDown : IconChevronRight;
            ...
            <h1 className="text-lg font-medium text-black ml-2">Unggahan</h1>
            <Link
              href="/admin/kegiatan"
              className="group flex w-full items-center rounded-lg p-2 text-base font-normal text-gray-900 transition duration-75 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 gap-3"
              passHref
