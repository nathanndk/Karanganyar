            ...
            <div className="flex flex-col md:flex-row w-full">
              {activities.slice(0, 2).map((activities, index) => (
                <div key={index} className="w-full md:w-1/2 p-4">
                  <Link href={`/kegiatan/detail?slug=${activities.slug}`}>
                    <div className="flex flex-col h-full">
                      ...
                      <p className="text-gray-600">
                        {moment(activities.date).format("LL")}
                      </p>
                      <p className="text-gray-600">
                        {moment(
                          moment(activities.date).format("YYYY-MM-DD") +
                            " " +
                      ...
                      <p className="text-gray-600">{activities.location}</p>
                    </div>
                  </Link>
                </div>
              ))}
              ...
              {activities.length > 1 && (
                <div className="w-full md:w-1/2 lg:w-1/2 p-4">
                  <div className="flex flex-col space-y-4">
                    {activities.slice(1, 4).map((activities, index) => (
...
//                 <div
//                   key={index}
//                   className="w-full md:w-1/2 p-4 shadow-lg rounded-lg bg-white"
//                 >
...
//                         alt={`Kegiatan ${index + 1}`}
//                         className="w-full h-64 md:h-80 rounded-t-lg mb-4 object-cover"
//                         width={500}
//                         height={500}
//                       />
...
//               {/* Most Recent Activities */}
//               {activities.length > 0 && (
//                 <div className="w-full md:w-1/2 lg:w-1/2 p-4 shadow-lg rounded-lg bg-white">
//                   <Link href={`/kegiatan/detail?slug=${activities[0].slug}`}>
//                     <div className="flex flex-col h-full">
//                       <Image
//                         src={activities[0].image.preview}
...
//                 <div className="w-full md:w-1/2 lg:w-1/2 p-4">
//                   <div className="flex flex-col space-y-4">
//                     {activities.slice(1, 4).map((activity, index) => (
//                       <div
//                         key={index}
//                         className="flex items-center space-x-4 shadow-lg rounded-lg bg-white p-4"
//                       >
//                         <Image
//                           src={activity.image.preview}
//                           alt={`Kegiatan ${index + 2}`}
