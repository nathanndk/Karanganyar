                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="w-full md:w-1/2">
                        ...
                        <p className="text-gray-800 dark:text-gray-300 text-lg md:text-xl leading-relaxed mb-6">
                            Kelurahan karangjati terletak di Kabupaten Sragen,
                            Jawa Tengah, Indonesia. Kelurahan ini terkenal
                            dengan kekayaan budaya dan sejarahnya, serta menjadi
                            tujuan wisata budaya yang penting.
                        </p>
                    ...
                    <div className="w-full md:w-1/2 h-80 md:h-full flex items-center justify-center">
                        <div className="relative w-full h-full">
                            <Image
                                ...
                                alt="Potensi Kelurahan karangjati"
                                layout="intrinsic"
                                width={500}
                                height={500}
