    ...
    return (
        <div className="relative w-full h-[60vh]">
            ...
            <div className="absolute inset-0">
                ...
                ></iframe> */}
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7912.733462349386!2d110.81998105!3d-7.42460495!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a0e6d5764d4c5%3A0x5027a76e355aac0!2sKarangjati%2C%20Kec.%20Kalijambe%2C%20Kabupaten%20Sragen%2C%20Jawa%20Tengah!5e0!3m2!1sid!2sid!4v1722766127624!5m2!1sid!2sid"
                    width="100%"
                    height="100%"
                    className="border-0"
                    allowFullScreen=""
            ...
            <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center p-4">
                <h1 className="text-lg lg:text-2xl font-bold mb-3 text-white text-center">
                    ...
                    <span className="text-white">Kelurahan Karangjati</span>
                </h1>
                <p className="mb-4 text-gray-200 text-sm lg:text-base text-center max-w-md">
                    Berikut adalah peta lokasi Kelurahan Karangjati, Kecamatan
