        ...
        <div className=" bg-white">
            <div className="container mx-auto px-4 py-8">
                <h1 className="text-2xl lg:text-4xl text-black dark:text-white font-bold mt-16 mb-5 lg:mb-5 text-center">
                    <span className="text-orange-500">Pendekatan Keluarga</span>{" "}
                    <span className="text-black">dalam Pelayanan</span>
                </h1>
                <div className="flex flex-col lg:flex-row items-center justify-center gap-16 mt-10 p-6 md:p-0">
