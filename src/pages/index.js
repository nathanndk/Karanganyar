...
import About from "@/components/organism/Landing/About-Home/Index";
import Head from "next/head";
import Hero from "@/components/organism/Landing/About-JP/Index";
import Welcome from "@/components/organism/Landing/beranda-hero/Index";
import Articles from "@/components/organism/Landing/Articles-Home/Index";
...
export default function Index({ data }) {
    return (
        <>
            <Head>
                <title>Karangjati - Overview</title>
                <meta
                    name="description"
                    content="Temukan misi, kegiatan, dan pembaruan terbaru dari Karangjati, kelurahan terbaik di sragen."
                />
                <meta
                    name="keywords"
                    content="Karangjati, kelurahan, sragen, jawa tengah, indonesia, kegiatan, berita, potensi, pembaruan"
                />
                <meta name="author" content="Tim Karangjati" />
                <meta property="og:title" content="Karangjati - Overview" />
                <meta
                    property="og:description"
                    content="Temukan misi, kegiatan, dan pembaruan terbaru dari Karangjati, sebuah kelurahan terbaik di Sragen."
                />
                <meta
                    property="og:url"
                ...
                />
                <meta property="og:site_name" content="Karangjati" />
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Karangjati - Overview" />
                <meta
                    name="twitter:description"
                    content="Temukan misi, kegiatan, dan pembaruan terbaru dari Karangjati, sebuah NGO terkemuka di Indonesia."
                />
                <meta
                    name="twitter:image"
                    content="https://janjipraptiningsih.com/path-to-image.jpg"
